...
const GET_ALL_LEAVES_API = "https://attendance-backend-3fjj.onrender.com/api/leave/";
const APPROVE_LEAVE_API = "https://attendance-backend-3fjj.onrender.com/api/leave/approve";
const REJECT_LEAVE_API = "https://attendance-backend-3fjj.onrender.com/api/leave/reject";
...
const AdminLeaveRequests = () => {
  ...
  const handleLeaveAction = async (id, action) => {
    try {
      ...
      setMessage(res.data.message || `Leave ${action} successfully!`);
        ...
        <>
          ...
          <div className="admin-leave-list">
            {leaveRequests
              .filter((leave) => leave.status === "Pending")
              .map((leave) => (
                <div key={leave._id} className="admin-leave-card">
                  <p><strong>Name:</strong> {leave.name}</p>
                  <p><strong>Type of Leave:</strong> {leave.typeOfLeave}</p>
                  <p><strong>Reason:</strong> {leave.reason}</p>
                  <p><strong>Date:</strong> {leave.startDate} → {leave.endDate}</p>
          ...
          <div className="admin-leave-list">
            {leaveRequests
              .filter((leave) => leave.status === "Approved")
              .map((leave) => (
                <div key={leave._id} className="admin-leave-card approved">
                  <p><strong>Name:</strong> {leave.name}</p>
                  <p><strong>Type of Leave:</strong> {leave.typeOfLeave}</p>
                  <p><strong>Reason:</strong> {leave.reason}</p>
                  <p><strong>Date:</strong> {leave.startDate} → {leave.endDate}</p>
          ...
          <div className="admin-leave-list">
            {leaveRequests
              .filter((leave) => leave.status === "Rejected")
              .map((leave) => (
                <div key={leave._id} className="admin-leave-card rejected">
                  <p><strong>Name:</strong> {leave.name}</p>
                  <p><strong>Type of Leave:</strong> {leave.typeOfLeave}</p>
                  <p><strong>Reason:</strong> {leave.reason}</p>
                  <p><strong>Date:</strong> {leave.startDate} → {leave.endDate}</p>
